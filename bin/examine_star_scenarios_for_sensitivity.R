...
# star_columns <- c('star', 'star_geo', 'star_geod', 'star_geou',  
# 'star_infa', 'star_infs')
...
# summary table of star species numbers in all classification method, 
# row=method by column=star. 
# sum_table <- rbind
# (star_table_star,star_table_star_geo,star_table_star_geou,
# star_table_star_geod,star_table_star_infa,star_table_star_infs)
# summary table of star species numbers in all classification method, row=star by column=method.
sum_table  <- cbind(star_table_star,star_table_star_geo,star_table_star_geou,
star_table_star_geod,star_table_star_infa,star_table_star_infs)
...
# bar plot
# barplot(sum_table,legend.text=c("star","star_geo","star_geou","star_geod","star_infa","star_infs"),
# beside=TRUE)
---------
# alternative way?
...
star_sens_table <- rbind(frequencies_star_default,frequencies_star_geo,frequencies_star_geou,
frequencies_star_geod, frequencies_star_infa,frequencies_star_infs)
