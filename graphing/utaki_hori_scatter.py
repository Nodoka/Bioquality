...
# 4 = gazcode (32 - 517)
# 11 = spcount as 'taxa'
# 22 = GHI40 for Utakigaz as 'validscore'
# 37 = XMGHI40
gazcode = np.genfromtxt(utaki_file, delimiter=',', dtype=None, skip_header=1, usecols=4)
utaki_score = np.genfromtxt(utaki_file, delimiter=',', dtype=None, skip_header=1, usecols=22)
utakihori_score = np.genfromtxt(utaki_file, delimiter=',', dtype=None, skip_header=1, usecols=37)
utakispcount = np.genfromtxt(utaki_file, delimiter=',', dtype=None, skip_header=1, usecols=11)
