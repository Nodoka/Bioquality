...
star_category = np.genfromtxt('../data/studysites_stardata.csv',delimiter=',',dtype=None,skip_header=1,usecols=0)
taxa_no = np.genfromtxt('../data/studysites_stardata.csv',delimiter=',',dtype=None,skip_header=1,usecols=range(1,4))
...
def plot_stacked_bar(results):
    ...
    plt.xticks(ind+width/2., ('RBS09','RBS10','Utaki') )
